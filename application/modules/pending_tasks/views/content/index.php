...
$num_columns	= 6;
$can_delete	= $this->auth->has_permission('Pending_Tasks.Content.Delete');
$can_edit		= $this->auth->has_permission('Pending_Tasks.Content.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/content/pending_tasks/edit/' . $record->id, '<span class="icon-pencil"></span> ' .  $record->created_by); ?></td>
				<?php else : ?>
