...
{
    protected $permissionCreate = 'Pending_tasks.Developer.Create';
    protected $permissionDelete = 'Pending_tasks.Developer.Delete';
    protected $permissionEdit   = 'Pending_tasks.Developer.Edit';
    protected $permissionView   = 'Pending_tasks.Developer.View';
    ...
    public function index($offset = 0)
    {
        ...
        $pagerUriSegment = 5;
        $pagerBaseUrl = site_url(SITE_AREA . '/developer/pending_tasks/index') . '/';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_pending_tasks()) {
                ...
                redirect(SITE_AREA . '/developer/pending_tasks');
            }
