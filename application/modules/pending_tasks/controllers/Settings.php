...
{
    protected $permissionCreate = 'Pending_tasks.Settings.Create';
    protected $permissionDelete = 'Pending_tasks.Settings.Delete';
    protected $permissionEdit   = 'Pending_tasks.Settings.Edit';
    protected $permissionView   = 'Pending_tasks.Settings.View';
    ...
    public function index($offset = 0)
    {
        ...
        $pagerUriSegment = 5;
        $pagerBaseUrl = site_url(SITE_AREA . '/settings/pending_tasks/index') . '/';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_pending_tasks()) {
                ...
                redirect(SITE_AREA . '/settings/pending_tasks');
            }
